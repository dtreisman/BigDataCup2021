...
![Random effects by player for *xG*. The top 10 NWHL players contribute between 0.045 and 0.11 *xG* to every shot, adjusting for other situational factors. The bottom 10 are between 0.048 and 0.08 less less *xG* on a given shot.](shooters.png){width="600"}
